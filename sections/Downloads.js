...
const CustomForm = ({ status, message, onValidated }) => {
  ...
  return (
    ...
    >
      ...
      {status === "success" && (
        <div
          style={{ color: "darkgreen", fontVariant:"small-caps",fontSize:"1.4em", fontWeight:"normal",lineHeight:"1.2em",}}><span style={{ color: "darkgreen", fontSize:"1.2em", lineHeight:"1.2em",}}>Thank you.</span> <br/>
          An email will be sent to you with the download link in a few minutes.<br/>
          <span style={{ color: "brown", fontSize:"0.9em", lineHeight:"1.2em",}}>(Check the Promotions tab in your mailbox)</span><br/> <br/> 
      ...
      <span style={{ color: "darkgreen", fontSize:"0.9em", lineHeight:"1.2em",}}>And if you want to support ONA,<br/>here is the Kickstarter page.</span>
           ...
           <div className="kickstarter-button">
                    <div className="kickstarter-button-wrapper">
                      <Button href="https://www.kickstarter.com/projects/maeone/ona" target="_blank" type="kickstarter" alt="Ona Kickstarter"></Button>
      ...
      />
      <br />
      <button style={{ fontFamily: "EB Garamond, serif",
                       color: "#fff",
      ...
      <div className="wrapper wrapper-white-bg">
        ...
        />
                ...
                <p className="text-for-free-demo">
                  <TextBlock textAlign="center" upper={true} fontSize="1.4rem" letterSpacing="0.1rem">
                   ...
                   FREE DEMO AVAILABLE<br />
                    ...
                    <TextBlock textAlign="center" upper={true}fontSize="0.8rem" letterSpacing="0.04rem" lineHeight="60px">
          ...
          <a href="https://discord.gg/CCjvmhpSAA" target="_blank">
            ...
            <br/> <br/> <br/>  
          </a>                      <div className="double-line2 only-pc"></div>
