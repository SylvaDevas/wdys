        ...
        <section>
            <div className="max-width-wrapper">
                ...
                <div className="wrapper">
                    <p className="intro-text2">universal<br/>interactive<br/>virtual journey<br/>to discover the
                        quest<br/>of our humanity.</p>
                    ...
                    <div className="left">
                        ...
                        <div className="paragraph">
                            ...
                            <TextBlock fontSize="0.9em" firstLetter={true}>
                                <p className="descript"><span className="subtitle">ONA </span>is an exploration
                                    game<br/>
                                    that invites us to a hypnotic<br/>journey around the world.<br/>
                                </p>
                                <p className="ecart">In search of meaning, discover <br/>the universal quest of our
                                    humanity.</p><br/>
                                ...
                                <div className="button-starter"><br/>
                                    <Button type="starter" target="_blank"
