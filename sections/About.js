      ...
      <section>
        ...
        <br/><br/>
          ...
          <div className="wrapper">
            ...
            <div className="right">
              <TextBlock>
                My name is Sylvain De Vreese and I’m a video artist, <br />storyteller and independent game developer.<br />
                <br />
          ...
          */}
                ...
                With the purpose of creation in mind, I began to travel around the world in search of evidence.<br />
               {/* During this journey, I continually collected incredible images of fascinating sacred places.<br /> */}
                My intention was to combine all the images into a unique experience inspired by my inner progression.<br />
                <br />
                Little by little, the concept of this creation evolved, and my ability to create it also grew.<br />
                The day is now coming when this dream comes true, and the doors of this game can finally be opened.<br />
                <br />
