                ...
                */}
                <div className="text-below-key">
                  ...
                  ONA - A MYSTICAL ART EXPERIENCE<br />
                    ...
                    <a href="http://eepurl.com/hff1jf" target="_blank" style={{color: "#357ac0", fontWeight: "bold"}}>Subscribe to our Newsletter </a> to keep an eye on the release. 
                  </TextBlock>
                  <br/>
                  ...
                  {<p className="campain-countdown" style={diff_days >= 31 ? {} : {display: "none"}}>
